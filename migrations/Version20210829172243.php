 ...
 */
final class Version20210829172243 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT NOT NULL, name VARCHAR(255) NOT NULL, weight INT DEFAULT NULL, price INT DEFAULT NULL, kg_price INT DEFAULT NULL, quantity INT DEFAULT NULL, PRIMARY KEY(id))');
